package com.andrewfleer.adventofcode2021.day4.task1;
...
public class GiantSquidBingo {
    ...
    private int playBingo(String[] bingoNumbers, List<BingoBoard> bingoBoards) {
        for (int i = 0; i < bingoNumbers.length; i++) {
            ...
            if (i > 3) {
                BingoBoard winningBoard = findWinningBoard(bingoBoards);
    ...
    private BingoBoard findWinningBoard(List<BingoBoard> bingoBoards) {
